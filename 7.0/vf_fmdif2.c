...
static const AVOption fmdif2_options[] = {
    ...
    { "cthresh", "set the area combing threshold used for combed frame detection",       OFFSET_FMDIF2(cthresh), AV_OPT_TYPE_INT, {.i64=10}, -1, 0xff, FLAGS },
    ...
    { "combpel", "set the number of combed pixels inside any of the blocky by blockx size blocks on the frame for the frame to be detected as combed", OFFSET_FMDIF2(combpel), AV_OPT_TYPE_INT, {.i64=160}, 0, INT_MAX, FLAGS },
